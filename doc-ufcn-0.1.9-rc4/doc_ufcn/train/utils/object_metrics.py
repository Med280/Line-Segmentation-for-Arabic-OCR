...
def __get_mean_ious(labels: list, predictions: list) -> float:
    """
    Get the mean Intersection-over-Union values of the predicted objects.
    :param labels: The coordinates of the ground truth objects.
    :param predictions: The coordinates of the predicted objects.
    :return: Mean of highest Intersection-over-Union
                  value for each predicted object.
    """
